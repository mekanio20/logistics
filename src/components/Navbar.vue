                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div class="flex items-center space-x-2">
                        <div v-for="item in icons" :key="item.id" @mouseenter="hoveredIcon = item.id"
                            ...
                            class="rounded-full cursor-pointer w-[30px] h-[30px] flex flex-col items-center justify-center bg-m_gray-400 dark:bg-black hover:bg-m_red-100 hover:-mt-1 duration-300">
                            <a :href="item.url">
                    ...
                    <div class="flex items-center space-x-2 cursor-pointer select-none relative" @click="toogleLang">
                        <svg class="w-[14px] stroke-[#E92A34] dark:stroke-white" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <p class="font-manjari font-normal text-sm text-m_gray-200 dark:text-white">{{ activeLang }}</p>
                        ...
                        <div v-if="isLang"
                            ...
                            <div v-for="item in languages" :key="item.id" class="flex items-center space-x-2 mb-2"
                                ...
                                <p class="font-manjari font-normal text-sm hover:text-m_red-100 duration-300">{{ item.title
                                    }}</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="fixed top-0 left-0 w-full h-full bg-white dark:bg-m_black-100 z-40 transition-all duration-500 ease-in-out"
        ...
        <div v-show="isOpen" class="p-8">
            ...
            <div class="w-full flex flex-col items-center text-center">
                <router-link v-for="item in pages" :key="item.id" :to="item.url"
                    class="w-full font-sf_pro font-medium lg:text-lg text-base cursor-pointer text-black dark:text-white py-4 border-b border-gray-200 dark:border-gray-500 hover:text-m_red-100 duration-300"
